...
<body>
  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col-lg-3">
          <button type ="button" class="btn btn-primary btn-lg" onclick="window.open('insert_window.php',config='height=400,width=1400')" >insert-DVD</button>
        </div>
      <div class="col-lg-3">
          <button type ="button" class="btn btn-primary btn-lg" onclick="window.open('list_window.php',config='height=400,width=1400')" >checking-order</button>
        </div>
      <div class="col-lg-3">
          <?php
          if(GetStatus()==2)
            echo "<button type='button' class='btn btn-primary btn-lg' onclick="."window.open('people_window.php',config='height=400,width=1400')"."> insert-member</button>";
         ?>
      </div>
      <div class="col-lg-3">
